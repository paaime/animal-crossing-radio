...
export default function Games() {
  ...
  return (
    <div className="absolute z-30 flex justify-center text-[#725D42] font-medium h-[230px] w-[245px] right-[10px] md:-right-[125px] -top-[200px] md:-top-[50px]">
