...
export default function Volume({ open }: { open: boolean }) {
  ...
  return (
    <AnimatePresence>
      {open && (
        <motion.div
          className="absolute z-30 flex justify-center text-[#725D42] font-medium h-[100px] w-[275px] right-[-15px] md:-right-[125px] -top-[110px] md:-top-[90px]"
