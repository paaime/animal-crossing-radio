...
export default function Time({ open }: { open: boolean }) {
  ...
  return (
    <AnimatePresence>
      {open && (
        <motion.div
          className="absolute z-30 flex justify-center text-[#725D42] font-medium h-[135px] w-[275px] right-[-10px] md:-right-[125px] -top-[130px] md:-top-[110px]"
        ...
        >
          ...
          <div className="flex flex-col items-start justify-center gap-1 w-3/4 z-20 font-bokutoh">
